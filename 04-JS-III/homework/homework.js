...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var acumuladorResultados = 0;
  var contadorResultados = 0;
  var promedio;

  for( var i = 0; i < resultadosTest.length; i++) {

    acumuladorResultados += resultadosTest[i];
    contadorResultados++;
  }
promedio = acumuladorResultados / contadorResultados;
...
function mesesDelAño(array) {
  ...
  if (arrayNuevo === ["Enero","Marzo","Noviembre"] ) { 
    return arrayNuevo;
  }
  else{
...
function breakStatement(numero) {
  ...
  while (contador < 11) {
    ...
    if(numero === contador) {
      mensaje = "Se interrumpio la ejecucion";
      break;
    }
    contador++;
  }
